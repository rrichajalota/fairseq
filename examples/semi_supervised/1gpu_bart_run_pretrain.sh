...
--lr 0.0004 --dropout 0.1 --criterion cross_entropy --max-tokens 8048 \
...
--update-freq 16 --seed 4 --distributed-world-size $NUM_GPUS \
--keep-best-checkpoints 10 \
--mask-length span-poisson --replace-length 1 --encoder-learned-pos \
--decoder-learned-pos --rotate 0.0 --mask-random 0.1 --save-dir /netscratch/jalota/checkpoints/subword-nmt-bpe-transformer_gpu1_cpu12 \
