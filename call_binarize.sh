...
binarize_big_lazy() {
    ...
    p2="/raid/data/daga01/data/qeAnnotatedWMT20and21/WMT21/en-de-da/BPE_32k"
    dest="/raid/data/daga01/data/qeAnnotatedWMT20and21/WMT21/en-de-da/data-bin-32k-lazy-${src}${tgt}"
    mkdir -p $dest
    #testfile=test_14 
    testfile="test21"
    #--cpu
